...
public abstract class FileUtils {
    ...
    public static void extractResource(
        ...
        try (
            InputStream stream = SimpleLockpicking.getInstance().getResource(resourcePath.toString().replace('\\', '/'))
        ) {
            if (stream == null)
    ...
    public static Set<String> resourceListFiles(
        ...
        final URL url = SimpleLockpicking.getInstance().getClass().getResource("");
